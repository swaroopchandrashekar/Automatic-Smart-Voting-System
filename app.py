...
def display():
    if os.path.exists('Result.txt'):
        ...
        num = f.readline()
        f.close()
        return render_template('display.html', result = 'Winner is {}'.format(num))
    else:
...
def getotp():
    ...
    client = Client("AC2cb6d77e2da512f70d2a9a29dc0b0426","b90dfffa8e24dbe978391b15c3464642")
    client.messages.create(to="+918971443039",from_="+16205368783",body=number)
